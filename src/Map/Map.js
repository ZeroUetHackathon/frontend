        ...
        <div id="info">
          <div id="header-info">
            ...
            <table id="feature-info">
              <tbody>
                <tr>
                  <th className="name" style={{width:"25%"}}>Name</th>
                  <th className="population" style={{width:"20%"}}>Population</th>
                  <th className="area" style={{width:"15%"}}>Area</th>
                  <th className="density" style={{width:"15%"}}>Density</th>
                  <th className="capital" style={{width:"25%"}}>Capital</th>
                </tr>
              </tbody>
            </table>
          </div>
